...
public class Oval extends Shape
{
    ...
    public Oval(Point pointCenter, int diameter1, int diameter2, Color color, boolean filled)
    {
        ...
        int pointDiameter1 = diameter1 / 2;
        int pointDiameter2 = diameter2 / 2;
        
        location[0] = new Point[center.x - pointDiameter1, center.y - pointDiameter2];
        location[1] = new Point[center.x + pointDiameter1, center.y - pointDiameter2];
        location[2] = new Point[center.x - pointDiameter1, center.y + pointDiameter2];
        location[3] = new Point[center.x + pointDiameter1, center.y + pointDiameter2];
